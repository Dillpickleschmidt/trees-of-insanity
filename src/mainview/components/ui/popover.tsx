...
const PopoverContent: Component<ComponentProps<typeof KobaltePopover.Content> & { showClose?: boolean }> = (props) => {
...
const PopoverDescription: Component<ComponentProps<typeof KobaltePopover.Description>> = (props) => {
	const [local, rest] = splitProps(props, ["class"]);
	return <KobaltePopover.Description class={cn("text-sm text-muted-foreground", local.class)} {...rest} />;
};
