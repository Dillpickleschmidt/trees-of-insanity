...
- **Flow overlay**: Plant-workspace GPU-animated dashed paths showing light toward the root and vigor toward terminals. Both use a blue-cyan-green-yellow-red weight map for their root-normalized flow fraction. It shows only flow that occurred in a completed plant step, never predicted or inactive routes.
