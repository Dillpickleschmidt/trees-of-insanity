...
- **Module diagnostic label**: compact Plant-workspace world-space readout anchored at every module root, with a speech-bubble tail ending at the projected root position, showing `Direct light`, `Accum. light`, and `Vigor` in aligned columns. It does not require hover or selection and does not display an internal module identifier.
