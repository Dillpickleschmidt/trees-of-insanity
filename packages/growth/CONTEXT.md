...
- **Conduit flow diagnostic**: conservation-preserving edge-level projection of canonical module light and vigor through the current committed plant structure. It is derived diagnostic information, not transition history, persistent simulation state, or a growth input.
