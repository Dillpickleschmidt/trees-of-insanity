...
- **Plant conduit network**: continuous rooted plant structure used by the Eq. 8 pipe model. Each module attachment makes the parent terminal and child root one shared conduit junction rather than introducing an edge or physical break; plant-scale and module-scale light/vigor remain separate calculations.
